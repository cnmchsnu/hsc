    ...
    return (
        <div className="flex-grow">
            ...
            {products.items.map((p: any) => (
                <Link href={`/products/${p.product.slug}`} key={p.product.slug} className="block">
                <div
                ...
                <div className="p-4">
                    ...
                    <span className="font-bold text-lg text-on-surface mb-2 line-clamp-1 block hover:underline">
                    {p.product.name}
                    </span>
                    <div className="flex items-center justify-between">
                    <span className="font-label-md text-headline-md text-on-primary-fixed-variant font-bold">
                        NT$ {p.displayPrice?.min?.amount ?? ""}
                    </span>
